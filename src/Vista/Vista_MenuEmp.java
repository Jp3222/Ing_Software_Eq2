...
public class Vista_MenuEmp extends javax.swing.JFrame {
    ...
    //
    private Sistema sistema = Sistema.getNodo();

    public Vista_MenuEmp() {
        initComponents();
        sistema.setJlbRelog(jlbRelog);
        sistema.setJlbFecha(jlbFecha);
    }
    ...
    private void initComponents() {
        ...
        jbtProductos.setBounds(0, 260, 300, 50);
